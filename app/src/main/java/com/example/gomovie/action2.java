...
public class action2 extends AppCompatActivity {
    ...
    private Button res2,time1,time2,time3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(action2.this, com.example.gomovie.action.class));
            }
        });
        ...
        res2.setOnClickListener(new View.OnClickListener() {
            ...
            private void openCart() {
                Intent intent = new Intent(action2.this, cart.class);
                startActivity(intent);}
            private void addToFavoris(String item) {
                int count = cartDetails.getOrDefault(item, 0);
                cartDetails.put(item, count + 1);
            }
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.wrath);
