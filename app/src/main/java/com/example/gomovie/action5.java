...
public class action5 extends AppCompatActivity {
    ...
    private Button res5,time1,time2,time3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(action5.this, com.example.gomovie.action.class));
            }
        });
        ...
        res5.setOnClickListener(new View.OnClickListener() {
            ...
            private void openCart() {
                Intent intent = new Intent(action5.this, cart.class);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.fast);
