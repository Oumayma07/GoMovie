...
public class action3 extends AppCompatActivity {
    ...
    private Button res3,time1,time2,time3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(action3.this, com.example.gomovie.action.class));
            }
        });
        ...
        res3.setOnClickListener(new View.OnClickListener() {
            ...
            private void openCart() {
                Intent intent = new Intent(action3.this, cart.class);
