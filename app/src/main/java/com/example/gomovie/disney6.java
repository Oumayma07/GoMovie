...
public class disney6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disney6);
        back1=findViewById(R.id.back1);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(disney6.this, com.example.gomovie.disney.class));
            }
        });
        ...
        res1.setOnClickListener(new View.OnClickListener() {
            ...
            private void openCart() {
                Intent intent = new Intent(disney6.this, cart.class);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.roi);
