...
public class comedy2 extends AppCompatActivity {
private ImageButton back1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comedy2);
        back1=findViewById(R.id.back1);
        back1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(comedy2.this, com.example.gomovie.comedie.class));
            }
        });
        ...
        res1.setOnClickListener(new View.OnClickListener() {
            ...
            private void openCart() {
                Intent intent = new Intent(comedy2.this, cart.class);
        ...
        Uri videoUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.thedo);
