    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(drama.this, com.example.gomovie.MainActivity.class));
            }
        });
        ...
        res1.setOnClickListener(new View.OnClickListener() {
            ...
            private void openCart() {
                Intent intent = new Intent(drama.this, drama1.class);
        ...
        res2.setOnClickListener(new View.OnClickListener() {
            ...
            private void openCart() {
                Intent intent = new Intent(drama.this, drama2.class);
                startActivity(intent);}
        ...
        res3.setOnClickListener(new View.OnClickListener() {
            ...
            private void openCart() {
                Intent intent = new Intent(drama.this, drama3.class);
                startActivity(intent);}
        ...
        res4.setOnClickListener(new View.OnClickListener() {
            ...
            private void openCart() {
                Intent intent = new Intent(drama.this, drama4.class);
                startActivity(intent);}
        ...
        res5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                addToCart("Film The Unforgivable:");
                openCart();
            }
            private void addToCart(String item) {
                int count = cartDetails.getOrDefault(item, 0);
            ...
            private void openCart() {
                Intent intent = new Intent(drama.this, drama5.class);
                startActivity(intent);}
        ...
        res6.setOnClickListener(new View.OnClickListener() {
            ...
            private void openCart() {
                Intent intent = new Intent(drama.this, drama6.class);
                startActivity(intent);}
