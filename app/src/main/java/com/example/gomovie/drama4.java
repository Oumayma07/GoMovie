...
public class drama4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(drama4.this, com.example.gomovie.drama.class));
            }
        });
        ...
        res1.setOnClickListener(new View.OnClickListener() {
            ...
            private void openCart() {
                Intent intent = new Intent(drama4.this, cart.class);
